...
export const translation: Translation = {
  themeInstalled: 'Helium Icon Theme wurde installiert.',
  howToActivate: 'Wie Icons aktivieren?',
  activate: 'Aktivieren',
  activated: 'Helium Icon Theme ist jetzt aktiviert.',
  neverShowAgain: 'Nicht mehr zeigen',
  themeUpdated: 'Das Helium Icon Theme wurde aktualisiert.',
